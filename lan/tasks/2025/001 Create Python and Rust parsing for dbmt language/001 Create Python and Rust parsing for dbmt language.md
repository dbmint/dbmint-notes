...
2026-06-16 Wk 25 Tue - 13:09 +03:00

Open a PR for  DBML_SQLite and bump version of pydbml

Spawn [000 Open a PR for  DBML_SQLite and bump version of pydbml](tasks/000%20Open%20a%20PR%20for%20%20DBML_SQLite%20and%20bump%20version%20of%20pydbml.md) <a name="spawn-task-c758ce" />^spawn-task-c758ce

Spawn [000 Installing a python project with a pyproject.toml](howtos/000%20Installing%20a%20python%20project%20with%20a%20pyproject.toml.md) <a name="spawn-howto-a6563b" />^spawn-howto-a6563b
...
## 3.3 Open a PR for dbml-rs to add better examples and fix README.md broken example
...
## 3.4 Add python pre-commit hooks to the project for style and correctness
...
## 3.5 File issue for non-recommended black hooks in pre-commit
...
We're trying to bump versions with this [PR Task](001%20Create%20Python%20and%20Rust%20parsing%20for%20dbmt%20language.md#34-open-a-pr-for-dbml_sqlite-and-bump-version-of-pydbml) to see if that helps the problem here. <a name="spawn-task-060923" />^spawn-task-060923
...
## 5.2 Git: How to diff between two tags

* [x] 

From [<a name="spawn-howto-061103" />^spawn-howto-061103](001%20Create%20Python%20and%20Rust%20parsing%20for%20dbmt%20language.md#spawn-howto-061103) in [6.1 Invst what happened to table.refs for pydbml](001%20Create%20Python%20and%20Rust%20parsing%20for%20dbmt%20language.md#61-invst-what-happened-to-tablerefs-for-pydbml)
...
## 5.3 Git: Find out when a line in a file was changed after a commit

* [x] 

From [<a name="spawn-howto-061125" />^spawn-howto-061125](001%20Create%20Python%20and%20Rust%20parsing%20for%20dbmt%20language.md#spawn-howto-061125) in [6.1 Invst what happened to table.refs for pydbml](001%20Create%20Python%20and%20Rust%20parsing%20for%20dbmt%20language.md#61-invst-what-happened-to-tablerefs-for-pydbml)
...
## 5.4 Add python project from github to requirements.txt
...
## 5.5 Parse a path string in python
...
## 5.6 Python parse enum from string with identical name to identifier
...
## 5.7 Use TypeVar variables to create generic functions in python
...
Spawn [5.3 Git How to diff between two tags](001%20Create%20Python%20and%20Rust%20parsing%20for%20dbmt%20language.md#53-git-how-to-diff-between-two-tags) ^spawn-howto-061103
...
Spawn [5.4 Git Find out when a line in a file was changed after a commit](001%20Create%20Python%20and%20Rust%20parsing%20for%20dbmt%20language.md#54-git-find-out-when-a-line-in-a-file-was-changed-after-a-commit) ^spawn-howto-061125
